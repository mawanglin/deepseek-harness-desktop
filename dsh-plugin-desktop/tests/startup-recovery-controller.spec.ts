...
describe('pre-Host Desktop startup recovery controller', () => {
  it('projects direct dependency uninstallability and browseable checkpoint metadata without paths or hashes', async () => {
    ...
    expect(snapshot.checkpoints).toEqual([
      { slotId: 'slot-1', status: 'available', capturedAt: '2026-08-21T00:00:00.000Z', appVersion: '2.0.3-2', provider: 'desktop-profile', fileCount: 1, pluginCount: 3, totalBytes: 20 },
      { slotId: 'slot-2', status: 'available', capturedAt: '2026-08-22T00:00:00.000Z', appVersion: '2.0.3-2', provider: 'desktop-profile', fileCount: 1, pluginCount: 4, totalBytes: 20 },
